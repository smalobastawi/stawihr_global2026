...
@section('title', trans('job_requisition.approve_requisition'))
            ...
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <i class="mdi mdi-check-circle fa-fw"></i>
                        @lang('job_requisition.approve_requisition'): {{ $result->requisition_number }}
                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label col-md-3">
                                                @lang('job_requisition.approval_comments')
                                            </label>
                                            <div class="col-md-9">
                                                <textarea name="approval_comments">{{ Request::old('approval_comments') }}</textarea>
                                                <span class="help-block">
                                                    @lang('job_requisition.approval_comments_help')
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-9 col-md-offset-3">
                                                    <button type="submit" class="btn btn-success btn_style">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#approveForm').submit(function(e) {
                if (confirm('@lang('job_requisition.confirm_approve')')) {
                    return true;
                }
                return false;
            });
