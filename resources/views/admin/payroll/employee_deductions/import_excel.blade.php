                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ul style="padding-left: 20px;">
                                    ...
                                    <li>Ensure all required fields (especially `payroll_number` and `deduction_name`) are present and correctly formatted.</li>
                                    <li>After a successful upload, review the employee deductions list to verify the imported data.</li>
                                </ul>
                            </div>
