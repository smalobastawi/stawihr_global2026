                            ...
                            <form method="POST" action="{{ route('payroll.employees.store') }}" class="form-horizontal">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <small class="text-muted">Currency in which basic salary and contract amounts are expressed.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    @include('admin.partials.currency-select', [
                                                        ...
                                                        'selected' => old('payment_currency'),
                                                        'required' => false,
                                                    ])
                                                    <small class="text-muted">Currency paid to the employee. Leave blank to use company default.</small>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    @include('admin.partials.currency-select', [
                                                        ...
                                                        'selected' => old('bank_payment_currency'),
                                                        'required' => false,
                                                    ])
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" id="disability_exemption_certificate_row"
                                        style="{{ old('disability_exemption') == 1 ? '' : 'display:none;' }}">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text"
                                                        ...
                                                        class="form-control"
                                                        value="{{ old('disability_exemption_certificate_number') }}"
