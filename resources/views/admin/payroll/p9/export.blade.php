...
<head>
    ...
    <title>P9 Download - 2025 KRA Format</title>
    <!-- Bootstrap Core CSS -->
...
<body style="padding: 15px; font-size: 10px; text-align: justify;">
    ...
    <table class="p9-table" style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            @foreach($salaryDetails as $salary)
                <tr>
                    <th scope="row" style="text-align: center;">{{ date('F', strtotime($salary['month'])) }}</th>
...
<div class="row" style="margin-top: 15px; font-size: 8px;">
    <div class="col-md-6">
