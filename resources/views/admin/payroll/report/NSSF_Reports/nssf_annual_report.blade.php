...
@section('title')
    @lang('salary_sheet.payroll_index')
@endsection
@section('content')
                    ...
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <form method="POST" action="{{route('payrollDataExport')}}">
                                    {{ csrf_field() }}
                                    <div class="col-md-3">
...
@endforeach
                                    ...
                                    <div class="col-md-3">
                                        <label >Submit</label>
                                        <input class="form-control btn btn-success pull-right m-l-20" type="submit" name="request_type" value="Generate-excel">
                                    </div>
                                    <div class="col-md-3">
                                        <label >Submit</label>
                                        <input class="form-control btn btn-success pull-right m-l-20" type="submit" name="request_type" value="Generate-PDF">
                                    </div>
                                </form>
