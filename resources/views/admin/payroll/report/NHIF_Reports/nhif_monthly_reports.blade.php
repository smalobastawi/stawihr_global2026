                            ...
                            <div id="searchBox">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <button name="action" type="button" id="filter" style="margin-top: 25px; width: 100px;" class="btn btn-info"> <a style="color: white" href="{{route('nhifReportsIndex')}}">Clear filter</a> </button>
