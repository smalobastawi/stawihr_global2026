...
@section('content')
@section('title')
    @lang('salary_sheet.master_payroll')
@endsection
...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="">
            ...
            <a href="{{ route('generateSalary.massGenerate') }}"  class="btn btn-success pull-right  waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Generate Payroll</a>
        </div>
    </div>
...
@endforeach
                        ...
                        <br>
                        <div class="data">
                            @include('admin.payroll.payroll.generatePayroll.pagination')
                        </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Net Pay</label>
