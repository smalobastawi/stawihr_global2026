    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('employee_earnings.index')}}">Employee Earnings</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"> Bulk Upload Employee Earnings</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ol style="padding-left: 20px;">
                                    <li style="margin-bottom: 15px;">
                                        ...
                                        Click the button to download the Excel template. The file includes dropdowns for specific columns to prevent errors.
                                        <br><a href="{{ route('payroll.bulk_upload.earnings.download_template') }}" class="btn btn-sm btn-primary m-t-5">Download Template</a>
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        <strong>2. Fill in the Template:</strong><br>
                                        Open the downloaded file and enter the employee earnings data. Do not change the column headers.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                ...
                                <ul style="padding-left: 20px;">
                                    ...
                                    <li>Ensure all required fields (especially `payroll_number` and `earning_type_name`) are present and correctly formatted.</li>
                                    <li>After a successful upload, review the employee earnings list to verify the imported data.</li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-6" style="border-left: 1px solid #e7e7e7;">
                                <h2>Upload File</h2>
                                <hr>
                                <form method="post" enctype="multipart/form-data" action="{{ route('employee_earnings.import') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <a href="{{ route('employee_earnings.index')}}" class="btn btn-default waves-effect waves-light">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
