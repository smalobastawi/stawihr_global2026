        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-info">
                    <div class="panel-heading"> Bulk Upload Banks</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <ol style="padding-left: 20px;">
                                        <li style="margin-bottom: 15px;">
                                            ...
                                            sample data.
                                            <br><a href="{{ route('banks.template.download') }}"
                                        ...
                                        <li style="margin-bottom: 15px;">
                                            ...
                                            Open the downloaded Excel file and enter your bank information. Do not change
                                            the column headers.
                                        </li>
                                        <li style="margin-bottom: 15px;">
                                    ...
                                    <ul style="padding-left: 20px;">
                                        ...
                                        <li>Ensure bank_code is unique across all banks.</li>
                                ...
                                <div class="col-md-6" style="border-left: 1px solid #e7e7e7;">
                                    ...
                                    <form method="post" enctype="multipart/form-data"
                                        action="{{ route('banks.import.process') }}">
                                        {{ csrf_field() }}
