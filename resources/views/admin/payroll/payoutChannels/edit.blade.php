...
@method('PUT')
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="name" value="{{ Request::old('name') }}" class="form-control required name" id="deduction_name" placeholder="E.g Nawiri Sacco">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Channel Type<span class="validateRq">*</span></label>
                                            <div class="col-md-8">
                                                <select name="type_of_channel" id="type_of_channel" class="form-control">
                                                    @foreach($payoutChannelTypes as $type => $value)
...
@foreach(array(1 => 'Active', 2 => 'Inactive') as $__key => $__value)
