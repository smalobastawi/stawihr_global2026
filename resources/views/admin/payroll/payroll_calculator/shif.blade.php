                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="ml-12">
                                            <div class="">
                                                ...
                                                <form class="" action="{{route('payrollcaculator.shif')}}" method="get">
                                                    @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control" name="nssf_rate_type">
                                                                    ...
                                                                    <option value="2"
                                                                        {{ isset($data['request']->nssf_rate_type) && $data['request']->nssf_rate_type === '2' ? 'selected' : 'selected' }}>
                                                                        Tier I & 2</option>
                                                                    <option value="3"
                                            ...
                                            @if(isset($data['request']->amount))
                                                <div class="ml-12">
                                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">SHIF:</div>
                                                            <div class="col-md-6 text-right"> <strong > {{number_format($data['shif_amount'], 2)}} </strong > </div>
                                                ...
                                                <hr>
                                                    <div class="row">
                                                        <div class="col-md-6 text-right"><a class="btn btn-primary" href="{{route('payrollcaculator.shif')}}"
