...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="">
            <a href="{{ route('managementPay') }}"  class="btn btn-success pull-right m-l-20  waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i> @lang('salary_sheet.generate_salary_sheet')</a>
            <a href="{{ route('downloadMgntPayslips') }}"  class="btn btn-success pull-right m-l-20  waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i>Generate Payslips PDF</a>

            <a href="{{ route('generateManagersPayrollExcel') }}"  class="btn btn-success pull-right m-l-20  waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i>Generate Excel</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
