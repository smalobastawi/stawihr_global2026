                        ...
                        <div class=" companyAddress">
                            <div class="row" style="margin-left: 30%">
                                ...
                                <h3   style="text-align: center;  margin-left: -30%;"><strong>Phone Number +254701 304585<br>
                                        P O BOX 1496, Nanyuki <br>
                                            Email Address info@mtkenyasprouts.com <hr>
                                        Payslip: {{convartMonthAndYearToWord($salaryDetails['salaryDetails']->month_of_salary)}}</strong></h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <table>
...
{{--                                @if(count($salaryDetails['salaryDetailsToBonuses']) > 0)--}}
...
{{$bonustotal =0}}
                                @foreach($salaryDetails['salaryDetailsToBonuses'] as $bonus)
                                    <tr style="background-color: #ddd">
                                        {{$bonustotal +=$bonus->amount_of_bonus}}
                                        <td>Bonuses:</td>
                                        <td> </td>
                                    </tr>
                                    <tr style="background-color: #ddd">
...
{{--                                <tr>--}}
{{--                                    <td>Bonuses :</td>--}}
{{--                                        <td class="text-center"> {{number_format($salaryDetails['salaryDetails']['total_bonuses'])}}</td>--}}
{{--                                </tr>--}}
...
{{--                                The gross adjusted on display because it was not showing corectly.--}}
                                <tr>
                                    <td>@lang('salary_sheet.gross_salary') :</td>
                                    <td class="text-center"
                                        style="background: #ddd"> {{number_format($salaryDetails['salaryDetails']->gross_pay+$salaryDetails['salaryDetails']['airtime_untaxed']+$bonustotal)}}</td>
                                </tr>
                        ...
                        <div class="col-md-6">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><b>{{$salaryDetails['salaryDetails']->total_working_days}}</b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">   {{$salaryDetails['salaryDetails']->total_absence}}   </td>
                                </tr>
                                ...
                                @endif
                                @if($salaryDetails['salaryDetails']->total_overtime_amount !=0)
                                    <tr>
                                        <td> @lang('salary_sheet.over_time') :</td>
                                        <td class="text-center">   {{$salaryDetails['salaryDetails']->total_over_time_hour}}   </td>
                                    </tr>
                                    <tr>
                                        <td> @lang('salary_sheet.over_rate') :</td>
                                        <td class="text-center">   {{$salaryDetails['salaryDetails']->overtime_rate}}  </td>
                                    </tr>
                                @endif
