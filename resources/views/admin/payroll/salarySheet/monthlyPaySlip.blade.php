		...
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
			<a href="{{route('payrollIndex')}}"
			   class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"><i
						class="fa fa-list-ul" aria-hidden="true"></i> Go to master payroll</a>
		</div>
		...
		<div class="col-md-12">
			<div class="panel panel-info">
				...
				<div class="col-md-12 text-right">
					<h4 style="">
						<a class="btn btn-success" style="color: #fff" href="{{ route('downloadPayslip',$paySlipId)}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> @lang('common.download') PDF</a>
					</h4>
				</div>
						...
						<div class="row" style="border: 1px solid #ddd;padding: 26px 9px">
							<div class="col-md-6">
								<table class="table table-bordered table-hover table-striped">
									...
									<!-- Salary Addvances show here -->
									@if(count($salaryDetailsToAdvances) > 0)
										@foreach($salaryDetailsToAdvances as $advance)
											<tr>
												<td>{{$advance->name}} :  </td>
												<td class="text-center"> {{number_format($advance->amount)}}</td>
											</tr>
										@endforeach
									@endif
									<tr>
										<td>@lang('salary_sheet.gross_salary') : </td>
										<td class="text-center" style="background: #ddd"> {{number_format($salaryDetails->gross_pay)}}</td>
									</tr>
									<tr>
										<td>@lang('salary_sheet.taxable_salary') :  </td>
										<td class="text-center"> {{number_format($salaryDetails->gross_pay-$salaryDetails->nssf_amount)}}</td>
									</tr>
									<tr>
										<td>P.A.Y.E:  </td>
									...
									@if(count($salaryDetailsToDeduction) > 0)
										@foreach($salaryDetailsToDeduction as $deduction)
											<tr>
												...
												<td class="text-center"> {{number_format($deduction->limit_per_month)}}</td>
											</tr>
										@endforeach
									@endif
									<!-- Salary Addvances show here -->
							...
							<div class="col-md-6">
								<table class="table table-bordered table-hover table-striped">
									...
									<tr>
										...
										<td class="col-md-6"> <b>{{$salaryDetails->payroll_no}}</b></td>
									</tr>
									<tr>
