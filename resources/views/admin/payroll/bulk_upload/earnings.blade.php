    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"> Bulk Upload Employee Earnings from Excel File</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ol style="padding-left: 20px;">
                                    ...
                                    <li style="margin-bottom: 15px;">
                                        ...
                                        Open the downloaded file and enter the employee earnings data.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                            ...
                            <div class="col-md-6" style="border-left: 1px solid #e7e7e7;">
                                <h2>Upload File</h2>
                                <hr>
                                <form method="post" enctype="multipart/form-data" action="{{ route('payroll.bulk_upload.earnings') }}">
                                    {{ csrf_field() }}
