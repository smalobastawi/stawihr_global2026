    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading"> Bulk Upload Overtime Records from Excel File</div>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <ol style="padding-left: 20px;">
                                    <li style="margin-bottom: 15px;">
                                        ...
                                        <br><a href="{{ route('payroll.overtime.bulk_upload.download_template') }}" class="btn btn-sm btn-primary m-t-5">Download Template</a>
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                        <strong>Fill in the Template:</strong><br>
                                        Open the downloaded file and enter the overtime records data.
                                    </li>
                                    <li style="margin-bottom: 15px;">
                                ...
                                <ul style="padding-left: 20px;">
                                    ...
                                    <li>Ensure all required fields (especially `payroll_number` and `month_year`) are present and correctly formatted.</li>
                                    <li>After a successful upload, review the overtime records list to verify the imported data.</li>
                                </ul>
                            </div>
                            ...
                            <div class="col-md-6" style="border-left: 1px solid #e7e7e7;">
                                <h2>Upload File</h2>
                                <hr>
                                <form method="post" enctype="multipart/form-data" action="{{ route('payroll.overtime.bulk_upload') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <a href="{{ route('payroll.overtime.index')}}" class="btn btn-default waves-effect waves-light">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
