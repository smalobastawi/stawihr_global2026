...
@section('title', 'Add Survey Answers')
        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                <a href="{{ route('survey.answers.index') }}"
                    ...
                    <i class="fa fa-list-ul" aria-hidden="true"></i> Survey Answers List
                </a>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                            ...
                            @endif
                            <form action="{{ route('survey.answers.store') }}" method="POST" enctype="multipart/form-data" id="surveyForm">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <div class="form-group">
                                                <label for="survey_question_id">Question<span
                                                        class="validateRq">*</span></label>
                                                <select name="survey_question_id" id="survey_question_id"
                                                    class="form-control">
                                                    <option disabled selected>Choose Survey Question</option>
                                                    @forelse ($surveyQuestions as $surveyQuestionTitle)
                                                        <option value="{{ $surveyQuestionTitle->id }}">
                                        ...
                                        <div class="row answer-group">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="answer_text[]" value="{{ // Notice the array [] to handle multiple inputs
                                                        Request::old('answer_text') }}" class="form-control required answer_text" placeholder="Answer">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <button type="button" class="btn btn-primary mt-2" id="addMoreAnswers">
