                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="exampleInput">
                                            @lang('common.from_date')<span class="validateRq">*</span>
                                        </label>
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="application_from_date" value="{{ Request::old('application_from_date') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="exampleInput">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="application_to_date" value="{{ Request::old('application_to_date') }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <label>
                                                    ...
                                                    <strong>Half Day Leave (0.5 day)</strong>
                                                </label>
                                            </div>
                                            <small class="text-muted">Check this if you want to apply for a half day leave. Only one date should be selected.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="purpose">{{ Request::old('purpose') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
