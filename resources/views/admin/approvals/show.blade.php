                                                            ...
                                                            <tbody>
                                                                ...
                                                                @else
                                                                    <tr class="text-center">
                                                                        <td colspan="{{ count($newData) ?: 1 }}">No Approval Record Found</td>
                                                                    </tr>
                                                                @endif
                                                            </tbody>
                                                        </table>
                                                ...
                                                <div class="box">
                                                    <div class="box-body" style="overflow-x: auto; max-height: 300px;">
                                                        ...
                                                        <div class="approvers_list">
                                                            ...
                                                            <ul>
                                                                @forelse($data['approvers'] as $approver)
                                                ...
                                                <div class="box">
                                                    <div class="box-body" style="overflow-x: auto; max-height: 300px;">
                                                        ...
                                                        <div class="approvers_status list">
                                                            <ul>
                                                                @forelse($data['already_approved_records'] as $record)
                                                                    <li>
                                                                        {{ $record['name'] }} - 
                                                                        <span class="status">
                                                                            @if($record['status'] == 1)
...
<script>
    ...
    // Submit Button click
        ...
        $('#submitBtn').click(function() {
            ...
            $.ajax({
                url: "{!! route('approvals.update', $data['id']) !!}",
                type: "PUT", 
                data: {
                    _token: "{{ csrf_token() }}", 
                    _method: "PUT",             
