								...
								<div class="sttabs tabs-style-iconbox">
									...
									<div class="content-wrap">
										<section id="section-iconbox-1">
											@if($data)
												<form method="POST" action="{{ route('generalSettings.update', $data->company_address_setting_id) }}" id="companyAddressForm" class="form-horizontal" enctype="multipart/form-data">
@csrf
@method('PUT')
											@else
												<form method="POST" action="{{ route('generalSettings.store') }}" id="companyAddressForm" class="form-horizontal" enctype="multipart/form-data">
@csrf
											@endif
												@if($errors->any())
										...
										<section id="section-iconbox-2">
											@if($printHeadData)
												<form method="POST" action="{{ route('printHeadSettings.update', $printHeadData->print_head_setting_id) }}" id="printHeadSettingsForm" class="form-horizontal" enctype="multipart/form-data">
@csrf
@method('PUT')
											@else
												<form method="POST" action="{{ route('printHeadSettings.store') }}" id="printHeadSettings" class="form-horizontal" enctype="multipart/form-data">
@csrf
											@endif
											@if($errors->any())
												<div class="alert alert-danger alert-dismissible" role="alert">
