							    ...
							    <div class="form-body">
								    ...
								    <div class="row">
                                        <div class="col-md-3 mt-1" style="margin-top:10px;">
                                                <label class="control-label">Select Module<span class="validateRq">*</span></label>
                                                <select type="text" class="form-control" name="module_id" placeholder="Select Module" select2>
