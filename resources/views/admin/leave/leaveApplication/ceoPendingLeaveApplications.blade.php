                                ...
                                @if(count($results) > 0)
                                    ...
                                    @foreach($results AS $value )
                                        <tr>
                                            ...
                                            <td>
                                                @if($value->ceo_approval_type==1)Pending
                                                @elseif($value->ceo_approval_type==2) Approved
                                                @elseif($value->ceo_approval_type==3) Rejected
                                                @elseif($value->ceo_approval_type==null) Pending
                                                @else Pending
                                                @endif
                                            </td>
