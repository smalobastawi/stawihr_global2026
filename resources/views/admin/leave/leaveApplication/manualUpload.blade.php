...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div >
            <a href="{{ route('leaveManagement.manualUploadView') }}"  class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i class="fa fa-plus-circle" aria-hidden="true"></i>Upload from Excel</a>
        </div>
                                        ...
                                        @foreach($results AS $value )
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <a href="{!!route('leaveApplication.delete',$value->leave_application_id  )!!}" data-token="{!! csrf_token() !!}" data-id="{!! $value->leave_application_id !!}" class="delete btn btn-danger btn-xs deleteBtn btnColor"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
