                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    @if (isset($leaveApplicationData->employee->photo) && $leaveApplicationData->employee->photo != '')
                                        <img style="width: 20px;margin: 0 auto"
                                            ...
                                            src="{!! employee_photo_url($leaveApplicationData->employee->photo) !!}" alt="User profile picture">
                                    @else
                                        <img width="100px" style="margin: 0 auto"
                                            class="profile-user-img img-responsive img-circle"
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach ($leaveApplicationData->justification as $justification1)
                                        <p>
                                            <a href="{{ leave_application_url($justification1->file_name ) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    @if ($leaveApplicationData->status == LeaveStatus::PENDING)
                                        <p class="col-md-6 col-sm-6 label-warning">Pending</p>
                                    @elseif($leaveApplicationData->status == LeaveStatus::APPROVE)
                                        <p class="col-md-6 col-sm-6 label-success">Approved</p>
                                   
                                    @elseif($leaveApplicationData->status == LeaveStatus::RECALL)
                                        <p class="col-md-6 col-sm-6 label-primary">Recalled</p>
                                    @else
...
@method('PUT')
                                ...
                                @if ($supervisor_id == session('logged_session_data.employee_id'))
                                    ...
                                    @else
                                        <div class="form-group">
                                            ...
                                            <p class="col-sm-8">
                                                <textarea class="form-control" cols="10" rows="6" name="remarks" required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="col-sm-8">
                                                ...
                                                <button type="submit" name="status"
                                                    class="btn btn-danger btn_style" value="3"> Reject
                                                </button>
                                            </p>
                                ...
                                @endif
                                {{-- @if (
                                    \Auth::user()->hasRole('HR Administrator') &&
                                        $leaveApplicationData->status == '2' &&
                                        $leaveApplicationData->hr_approval == '1')
                                    @if (session('logged_session_data.employee_id') == $leaveApplicationData->employee_id)
                                        <label>You cannot approve your own leave application</label>
