            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form action="{{ route('applyForLeave.update') }}" method="POST" enctype="multipart/form-data" id="leaveApplicationForm">
@csrf

                        <div class="form-body">
                            <div class="row">
                                <input type="hidden" name="employee_id" value="{{ (isset($getEmployeeInfo)) ? $getEmployeeInfo->employee_id:'' }}" class="employee_id">
                                <input type="hidden" name="leave_application_id" value="{{ (isset($leaveApplication)) ? $leaveApplication->leave_application_id:'$leaveApplication->leave_application_id' }}" class="leave_application_id">
...
<option value="{{ $__key }}" {{ (string)Input::old('leave_type_id') == (string)$__key ? 'selected' : '' }}>{{ $__value }}</option>
@endforeach
</select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="application_from_date" value="{{ Input::old('application_from_date') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                        <input type="text" name="application_to_date" value="{{ Input::old('application_to_date') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="purpose">{{ Input::old('purpose') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="exampleInput">Reliever<span
                                                    class="validateRq">*</span></label>
                                        <select name="reliever_id" class="form-control reliever_id select2 required">
@foreach($employeeList as $__key => $__value)
<option value="{{ $__key }}" {{ (string)Input::old('reliever_id') == (string)$__key ? 'selected' : '' }}>{{ $__value }}</option>
@endforeach
</select>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" id="formSubmit" class="btn btn-info "><i class="fa fa-paper-plane"></i> Edit Application</button>
                                </div>
                            </div>
                        </div>
                        </form>
