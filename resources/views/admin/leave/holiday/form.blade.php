				...
				<div class="panel panel-info">
					...
					<div class="panel-wrapper collapse in" aria-expanded="true">
						<div class="panel-body">
							@if(isset($editModeData))
								<form action="{{ route('holiday.update', $editModeData->holiday_id) }}" method="POST" enctype="multipart/form-data" id="holidayForm" class="form-horizontal">
@csrf
@method('PUT')

							@else
								<form action="{{ route('holiday.store') }}" method="POST" enctype="multipart/form-data" id="holidayForm" class="form-horizontal">
@csrf
								...
								<div class="row">
									<div class="col-md-8">
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" name="holiday_name" class="form-control" value="{{ Request::old('holiday_name', isset($editModeData) ? $editModeData->holiday_name : '') }}">
											</div>
										</div>
									</div>
								</div>
