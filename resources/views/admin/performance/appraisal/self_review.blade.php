...
@section('content')
@section('title')
Self Review - {{ $appraisal->employee ? $appraisal->employee->full_name : '' }} ({{ $appraisal->review_period }})
@endsection
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        <form action="{{ route('performance.appraisal.saveSelfReview', $appraisal->appraisal_id) }}" method="POST" id="selfReviewForm">
                            @csrf
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="tr_header">
                                                ...
                                                <th>Self Weighting<span class="validateRq">*</span></th>
                                                <th>Comments</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($faScore['scores'] as $score)
                                                <tr>
                                                    ...
                                                    <td>{{ $score->goal ? Str::limit($score->goal->performance_target, 60) : '' }}</td>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn btn-info btn_style"><i class="fa fa-check"></i> Save Self Review</button>
                                </div>
                                <div class="col-md-6">
