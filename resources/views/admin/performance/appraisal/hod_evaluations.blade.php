...
<div class="container-fluid">
    ...
    <!-- Status Summary for HOD -->
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="white-box" style="background: #fcf8e3; border-left: 4px solid #8a6d3b;">
                <h3 class="box-title" style="color: #8a6d3b;">Awaiting HOD Review</h3>
                ...
                <p class="text-muted small">Appraisals completed by supervisor</p>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="white-box" style="background: #e8f4f8; border-left: 4px solid #1e88e5;">
                <h3 class="box-title" style="color: #1e88e5;">In Progress</h3>
                <ul class="list-inline two-part">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-primary">
                <div class="panel-heading"><i class="fa fa-user-md fa-fw"></i> @yield('title') - Appraisals Requiring HOD Review</div>
                    ...
                    <div class="panel-body">
                        ...
                        @if($results->count() > 0)
                            <div class="alert alert-info">
                                <i class="fa fa-info-circle"></i> <strong>Action Required:</strong> You have {{ $results->count() }} appraisal(s) awaiting HOD review. Click the "Review" button to complete the HOD evaluation and development planning.
                            </div>
                        @else
                            <div class="alert alert-success">
                                <i class="fa fa-check-circle"></i> <strong>All Caught Up!</strong> No appraisals are currently awaiting your HOD review.
                            </div>
                        @endif
                                ...
                                <tbody>
                                    ...
                                    @foreach($results as $value)
                                        <tr class="{!! $value->appraisal_id !!}">
                                            ...
                                            <td>
                                                @if($value->status == 'supervisor_review')
                                                    <span class="label label-warning">Supervisor Complete</span>
                                                    <br><small class="text-muted">Ready for HOD review</small>
                                                @elseif($value->status == 'hod_review')
                                                    <span class="label label-primary">HOD In Progress</span>
                                            ...
                                            <td style="width: 150px; text-align: center;">
                                                ...
                                                @if(in_array($value->status, ['supervisor_review', 'hod_review']))
                                                    <a href="{!! route('performance.appraisal.hodReview', $value->appraisal_id) !!}" class="btn btn-primary btn-sm btnColor" title="Complete HOD Review" style="margin-left: 5px;">
