...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div>
                <a href="{{ route('attendance.anomalies')}}"
                   class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                            class="fa fa-folder-plus" aria-hidden="true"></i> Go to anomalies list</a>
            </div>
        </div>
        <h3 align="center">Upload employees from excel file</h3>
        <br/>
        @if(count($errors) > 0)
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('attendance.storeFromExcel') }}">
            {{ csrf_field() }}
        ...
        <div class="col-md-4">
            ...
            <br>
            <div class="">
                <label>Before importing Ensure:</label>
                <ol>
                    <li>The Excel file has been filled accurately to avoid errors</li>
                    <li>The workshift field is required</li>
                </ol>
            </div>
