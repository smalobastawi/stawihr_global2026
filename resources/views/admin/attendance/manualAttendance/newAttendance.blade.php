                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-wrapper collapse in" aria-expanded="true">
                        ...
                        <!-- Migrate to the new interface -->
                            ...
                            <div class="row">
                                <div id="searchBox">
                                    <form action="{{ route('newAttendance.filter') }}" id="employeeAttendance" method="GET">
                                    <div class="col-md-3">
                            ...
                            <hr>
                                ...
                                <form action="{{ route('newAttendance.store') }}" id="employeeAttendance" method="POST">@csrf
                                    ...
                                    <table class="table table-bordered" style="margin-bottom: 47px">
                                            ...
                                            @foreach($attendanceData as $value)
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 200px">
                                                        <select onchange="presenceChange('{{$value->employee_id}}')"
                                                                name="presence[]" class="form-control"
                                                                id="presenceSelect{{$value->employee_id}}">
                                                            @foreach($presences as $pr=>$pv)
                                                                <option @if($pr==$value->presence) selected
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="bootstrap-timepicker">
                                                                @if( (empty($value->outTime)) )
                                                                    <input readonly
                                                                           id="timeOutField{{$value->employee_id}}"
                                                                           type="text"
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td colspan="5">No data selected. Choose a date and departmet to show
                                                    data.
                                                </td>
                                            </tr>
                                        @endif
...
@section('page_scripts')
    <script>
        ...
        $(document).on("focus", ".timePicker-lunchCheckIn", function () {
            $(this).timepicker({
                showInputs: false,
                minuteStep: 1,
        ...
        function presenceChange(in_id) {
            ...
            if (prval === "PRESENT") {
                ...
                $("#lunchCheckInField" + in_id).removeAttr("readonly").attr("class", "form-control  timePicker-lunchCheckIn").attr("required", "required");
