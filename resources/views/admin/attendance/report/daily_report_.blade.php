                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        ...
                        @if(count($results) > 0)
                            <h4 class="text-right">
                                @if(isset($formData))
                                    <a target="_blank" class="btn btn-success" style="color: #fff" href="{{ URL('attendance/downloadDailyAttendance/'.dateConvertFormtoDB($formData))}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> @lang('common.dwonload') PDF</a>
                                @else
                                    <a class="btn btn-success" style="color: #fff" href="{{ URL('attendance/downloadDailyAttendance/'.date('Y-m-d') )}}"><i class="fa fa-download fa-lg" aria-hidden="true"></i> @lang('common.dwonload') PDF</a>
                                @endif
                            </h4>
                        @endif
