...
<!DOCTYPE html>
	<html lang="en">
	<head>
		<title>@lang('attendance.monthly_attendance_report')</title>
		<meta charset="utf-8">
	</head>
	@if(App::getLocale() == 'th')
	<style>
    ...
    src: url('{{ url('fonts/Garuda-Bold.ttf') }}');

     }


	@font-face {
    font-family: 'Garuda-BoldOblique';
    src: url('{{ url('fonts/Garuda-BoldOblique.ttf') }}');

     }

	@font-face {
    font-family: 'Garuda-Oblique';
    src: url('{{ url('fonts/Garuda-Oblique.ttf') }}');

     }
	@font-face {
    font-family: 'Garuda';
    src: url('{{ url('Garuda.ttf') }}');

     }

	body{
     
	 font-family: 'Garuda-Bold','Garuda-BoldOblique','Garuda-Oblique','Garuda',Arial;
	...
	<div class="printHead">
		...
		@endif
		<br>
		<p style="margin-left: 42px;margin-top: 10px"><b>@lang('attendance.monthly_attendance_report')</b></p>
	</div>
	<div class="container">
		...
		<table class="table">
			...
			@else
				<tr>
					<td colspan="9"><strong>@lang('common.no_data_available') !</strong></td>
				</tr>
			@endif
			<?php 
