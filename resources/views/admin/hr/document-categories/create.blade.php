...
@section('content')
@section('title')
@lang('documents.add_document_category')
@endsection
	<style>
		.appendBtnColor{
			color: #fff;
				...
				<div class="panel panel-info">
					...
					<div class="panel-wrapper collapse in" aria-expanded="true">
						<div class="panel-body">
							...
							@endif
                            <form method="POST" action="{{ route('document-categories.store') }}">
							@csrf
							    ...
							    <div class="form-body">
								    ...
								    <div class="row">
										...
										<div class="col-md-6">
											...
											<div class="input-group">
												<div class="input-group-addon"><i class="ti-user"></i></div>
												<textarea class="form-control required category_description" required id="category_description"
