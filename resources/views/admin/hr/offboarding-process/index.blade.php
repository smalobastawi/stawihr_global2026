...
@section('content')
@section('title')
@lang('offboarding.off_boarding_process_items')
@endsection
						...
						<div class="table-responsive">
							<table id="myTable" class="table table-bordered">
								<thead>
									 <tr class="tr_header">
                                        <th>#</th>
                                        <th>@lang('offboarding.checklist_name')</th>
                                        <th>@lang('offboarding.created_on')</th>
                                        <th>@lang('offboarding.created_by')</th>
                                        <th style="text-align: center;">@lang('common.action')</th>
                                    </tr>
								</thead>
								<tbody>
									{!! $sl=null !!}
									@foreach($offboarding_items AS $op)
										<tr class="{!! $op->id !!}">
											<td >{!! ++$sl !!}</td>
											...
											<td style="width: 100px;">
												...
												@can("documents-upload.edit")
													<a href="{!! route('documents-upload.edit',$op->id) !!}"  class="btn btn-success btn-xs btnColor" >
														<i class="iconFontSize mdi mdi-pencil hideMenu"></i>
													</a>
												@endcan
                                           
												
													<a href="{!! route('documents-upload.delete', $op->id) !!}" 
