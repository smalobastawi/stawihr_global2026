...
@section('content')
    ...
    <div class="container-fluid">
            ...
            <div>
                <a href="{{ route('termination.index')}}"
                   class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                            class="fa fa-folder-plus" aria-hidden="true"></i> Go to termination list</a>
            </div>
        </div>
        <h3 align="center">Upload terminations from excel file</h3>
        <br/>
        @if(count($errors) > 0)
        ...
        @endif
        <form method="post" enctype="multipart/form-data" action="{{ route('termination.importSave') }}">
            {{ csrf_field() }}
