                                        ...
                                        @if (count($employeeInfo->case) > 0)
                                            @foreach ($employeeInfo->case as $key => $case)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ stored_upload_url($case->attachment ) }}">
                                                            View </a>
                                                    </td>
                                                    <td>{{ $case->status }}</td>
                                                </tr>
                                    ...
                                    <div class="col-md-offset-2 col-xs-6 col-sm-6 col-md-6">
                                        <div class="text-right">
                                            ...
                                            @if (!empty($isRestorable) && $isRestorable)
                                                <a href="{!! route('employee.restore', $employeeInfo->employee_id) !!}"
                                                    data-token="{!! csrf_token() !!}"
                                            ...
                                            <a href="{!! route('employee.delete', $employeeInfo->employee_id) !!}" data-token="{!! csrf_token() !!}"
                                                ...
                                                <i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                            <a href="{!! route('employee.purge', $employeeInfo->employee_id) !!}" data-token="{!! csrf_token() !!}"
                                                data-id="{!! $employeeInfo->employee_id !!}"
                                                data-redirect="{{ route('employee.inactive.index') }}"
                                                class="permanent-delete-employee btn-xs deleteBtn btnColor"
                                                title="Permanently delete employee, linked user, and all related records">
                                                <button class="btn btn-dark">Permanent Delete</button>
