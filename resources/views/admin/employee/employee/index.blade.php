        ...
        <div>
            ...
            <a href="{{ route('employee.active') }}"
                class="btn btn-success pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                    ...
                    <a href="{{ route('employee.inactive.index') }}"
                    class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light"> <i
                        class="fa fa-eye" aria-hidden="true"></i>Inactive</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-teal">
                                    <a href="{{ route('employee.index') }}">
                                        <div class="inner">
                                            <canvas id="staffChart" width="100" height="100"></canvas>
                                        </div>

                                    </a><a href="{{ route('employee.index') }}" class="small-box-footer">By Gender <i
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-maroon"><a href="{{ route('contract.index') }}">

                                        <div class="inner">

                                            <canvas id="contractsChart" width="100" height="100"></canvas>
                                        </div>

                                    </a><a href="{{ route('contract.index') }}" class="small-box-footer">Contracts <i
                                            class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                                </div>
...
<script>
    ...
    const contractsChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
            data: [{{ $activeContracts }}, {{ $expiringContracts }}], // Active, Expiring
            backgroundColor: ['#4CAF50', '#FF9800'], // Colors for the slices
        }]
        },
        options: {
            responsive: true,
    ...
    // Gender data passed from Laravel to JavaScript
    const genderCounts = @json($genderCounts); // This will convert the PHP array to a JS object
    const labels = Object.keys(genderCounts); // ['Male', 'Female']
    const counts = Object.values(genderCounts); // [30, 28]


    console.log(genderCounts);

    // Create the pie chart
    const staff = document.getElementById('staffChart').getContext('2d');
    const staffChart = new Chart(staff, {
        type: 'pie',
        data: {
