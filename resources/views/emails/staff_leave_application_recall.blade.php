        ...
        <tr>
            <td align="center">
                <table class="email-container">
                    <tr>
                        <td class="header">
                            <h1>Leave Recalled</h1>
                        </td>
                    </tr>
                    <tr>
                        <td class="content">
                            <p>Your leave of <strong>{{ $content['no_of_days'] }}</strong> day(s). has been recalled</p>
                            ...
                            <p>If you did not perform this action, contact your supervisor. .</p>
                        </td>
                    </tr>
                    <tr>
