...
class PayrollCalculatorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.payroll.payroll_calculator_public.index', compact('currentMonth'));
    }
    ...
    public function calculate_PAYE(Request $request)
    {
        ...
        return view('admin.payroll.payroll_calculator_public.paye', ['data' => $data]);
    }
    ...
    public function calculateAHL_employee(Request $request)
    {
        ...
        return view('admin.payroll.payroll_calculator_public.ahl', ['data' => $data]);
    }
    ...
    public function calculateNHIF(Request $request)
    {
        ...
        return view('admin.payroll.payroll_calculator_public.nhif', ['data' => $data]);
    }
    public function calculateNSSF(Request $request)
    {
        ...
        return view('admin.payroll.payroll_calculator_public.nssf', ['data' => $data]);
    }
