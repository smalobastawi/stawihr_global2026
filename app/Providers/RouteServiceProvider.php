...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->routes(function () {
            ...
            Route::prefix('api/ess')->middleware('api')->group(base_path('routes/api_ess.php'));
            Route::prefix('api/internal')->middleware('api')->group(base_path('routes/internal-api.php'));
        ...
        Route::middleware('web')->group(base_path('routes/pdp.php'));
    ...
    protected function configureRateLimiting()
    {
        RateLimiter::for('api', function (Request $request) {
            // Local/testing: avoid blocking mobile app development traffic.
            if (app()->environment(['local', 'testing'])) {
                return Limit::none();
            }

            // Authenticated mobile/API clients get their own higher bucket.
            if ($token = $request->bearerToken()) {
                return Limit::perMinute(300)->by('token:' . hash('sha256', $token));
            }
