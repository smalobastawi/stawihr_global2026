...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_sections', function (Blueprint $table) {
            ...
            $table->foreignId('location_id')->nullable()->constrained('location', 'location_id')->onUpdate('cascade')->restrictOnDelete();
            $table->foreignId('created_by')->nullable()->constrained('employee', 'employee_id')->onUpdate('cascade')->restrictOnDelete();
